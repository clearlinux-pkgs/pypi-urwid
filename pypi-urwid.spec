...
Source0  : https://files.pythonhosted.org/packages/8e/74/8c2082f2b07a72ff5d2438447c13a70f0cbede73584e0a262c166a30785c/urwid-2.6.10.tar.gz
...
%prep
%setup -q -n urwid-2.6.10
cd %{_builddir}/urwid-2.6.10
pushd ..
cp -a urwid-2.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711374227
