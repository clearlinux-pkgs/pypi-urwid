...
Source0  : https://files.pythonhosted.org/packages/85/b7/516b0bbb7dd9fc313c6443b35d86b6f91b3baa83d2c4016e4d8e0df5a5e3/urwid-2.6.15.tar.gz
...
%prep
%setup -q -n urwid-2.6.15
cd %{_builddir}/urwid-2.6.15
pushd ..
cp -a urwid-2.6.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720041266
