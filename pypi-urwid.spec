...
Version  : 2.6.5
Release  : 89
URL      : https://files.pythonhosted.org/packages/d3/7d/3fcee8213c969683fc30392d92e3b066de65f53a771fbdfca40be01ea28b/urwid-2.6.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/d3/7d/3fcee8213c969683fc30392d92e3b066de65f53a771fbdfca40be01ea28b/urwid-2.6.5.tar.gz
...
%prep
%setup -q -n urwid-2.6.5
cd %{_builddir}/urwid-2.6.5
pushd ..
cp -a urwid-2.6.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708969909
