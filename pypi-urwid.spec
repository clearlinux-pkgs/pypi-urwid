...
Source0  : https://files.pythonhosted.org/packages/ef/fd/77d351caa11c438c7536bba12ea26bb1f22fe7fd0d9aa65849d4625c3e2d/urwid-2.6.11.tar.gz
...
%prep
%setup -q -n urwid-2.6.11
cd %{_builddir}/urwid-2.6.11
pushd ..
cp -a urwid-2.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713808064
