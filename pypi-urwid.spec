...
Source0  : https://files.pythonhosted.org/packages/2b/a0/dbf80c29a8ba7a0f3fdcf0a70f4924f83bc611aff21bc5bfc268b545bcbb/urwid-2.6.6.tar.gz
...
%prep
%setup -q -n urwid-2.6.6
cd %{_builddir}/urwid-2.6.6
pushd ..
cp -a urwid-2.6.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709080213
