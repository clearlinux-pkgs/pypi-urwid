...
Source0  : https://files.pythonhosted.org/packages/9e/e0/afd5f41a87cba266418622dc6e37fd18f61378aa56d73ea9ee01db3ceadd/urwid-2.6.12.tar.gz
...
%prep
%setup -q -n urwid-2.6.12
cd %{_builddir}/urwid-2.6.12
pushd ..
cp -a urwid-2.6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715700517
