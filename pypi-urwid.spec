...
Version  : 2.4.2
Release  : 77
URL      : https://files.pythonhosted.org/packages/da/81/fb36613477f486f9c9d93cdf248f7df9874c791b37d4942203f200cc5ac7/urwid-2.4.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/da/81/fb36613477f486f9c9d93cdf248f7df9874c791b37d4942203f200cc5ac7/urwid-2.4.2.tar.gz
...
%prep
%setup -q -n urwid-2.4.2
cd %{_builddir}/urwid-2.4.2
pushd ..
cp -a urwid-2.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705001147
