...
Source0  : https://files.pythonhosted.org/packages/81/f4/fa6da5de99e11e60d826567609eaa815146f835285a26f6c0f61e6015e2c/urwid-2.2.3.tar.gz
...
%prep
%setup -q -n urwid-2.2.3
cd %{_builddir}/urwid-2.2.3
pushd ..
cp -a urwid-2.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697728532
